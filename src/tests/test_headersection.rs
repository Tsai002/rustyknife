...
fn basic_line() {
    ...
    assert_eq!(
        parsed,
        [
            Ok((b"X-Mozilla-Status".as_ref(), b" 0001".as_ref())),
...
fn bad_nl() {
    let parsed =
        hs(b"X-Mozilla-Status: 0001\r\nX-Mozilla-Status2: 00800000\nmore stuff\r\n\r\n".as_ref());
    assert_eq!(
        parsed,
        [
            Ok((b"X-Mozilla-Status".as_ref(), b" 0001".as_ref())),
            Ok((
                b"X-Mozilla-Status2".as_ref(),
                b" 00800000\nmore stuff".as_ref()
            ))
        ]
    );
...
fn big_garbage() {
    ...
    assert_eq!(
        ...
        [
            ...
            Ok((
                b"Date".as_ref(),
                b" Thu, 09 Feb 2012 14:02:35 -0500".as_ref()
            ))
        ]
    );
}
